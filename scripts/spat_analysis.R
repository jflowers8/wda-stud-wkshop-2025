...
cellsize<-2 * sqrt(cellarea/((3*sqrt(3)/2))) * sqrt(3)/2#Set the grid cell size (opposite edge length) as a function of desired cell area, this is the input the st_make_grid function takes
